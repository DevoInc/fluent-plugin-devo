...
Gem::Specification.new do |s|
  s.name = "fluent-plugin-devo".freeze
  ...
  s.authors = ["Devo Inc.".freeze]
  s.date = "2021-06-14"
  s.description = "Syslog TLS output plugin with formatting support, for Fluentd".freeze
  s.email = ["support@devo.com".freeze]
  s.homepage = "https://github.com/DevoInc/fluent-plugin-devo".freeze
  s.licenses = ["Apache v2".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.1.2".freeze
  s.summary = "Fluent Syslog TLS output plugin for Devo".freeze
